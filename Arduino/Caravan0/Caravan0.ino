...
//Button Read
  ...
  bob = (analogRead(deskBob) > 270)? true : false;
...
void check(){
  if(RemoteXY.sw_47 == 1 || RemoteXY.sw_53 == 1 || RemoteXY.sw_37 == 1 || RemoteXY.sw_45 == 1 || RemoteXY.sw_35 == 1
